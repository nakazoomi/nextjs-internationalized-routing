...
export default function appWithI18n(AppToTranslate, config) {
    ...
    function AppWithTranslations(props) {
        ...
        return (React.createElement(I18nProvider, { lang: ((_a = props.pageProps) === null || _a === void 0 ? void 0 : _a.__lang) || props.__lang || defaultLocale, namespaces: ((_b = props.pageProps) === null || _b === void 0 ? void 0 : _b.__namespaces) || props.__namespaces, logger: logger, loadLocaleFrom: loadLocaleFrom },
