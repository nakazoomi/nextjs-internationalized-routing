...
function loadNamespaces(config) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var __lang, page, namespaces, defaultLoader, pageNamespaces, color;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    __lang = config.locale || ((_a = config.router) === null || _a === void 0 ? void 0 : _a.locale) || config.defaultLocale || '';
                    if (!config.pathname) {
                    ...
                    page = removeTrailingSlash(config.pathname.replace(/\/index$/, '')) || '/';
                    return [4, getPageNamespaces_1.default(config, page, config)];
                case 1:
                    namespaces = _b.sent();
                    defaultLoader = function (l, n) { return Promise.resolve({}); };
                    return [4, Promise.all(namespaces.map(function (ns) {
                            return typeof config.loadLocaleFrom === 'function'
                                ? config.loadLocaleFrom(__lang, ns)
                                : defaultLoader(__lang, ns);
                        })).catch(function () { })];
                case 2:
                    pageNamespaces = (_b.sent()) || [];
                    if (config.logBuild !== false && typeof window === 'undefined') {
                        color = function (c) { return "\u001B[36m" + c + "\u001B[0m"; };
                        console.log(color('next-translate'), "- compiled page:", color(page), '- locale:', color(__lang), '- namespaces:', color(namespaces.join(', ')), '- used loader:', color(config.loaderName || '-'));
                    }
                    return [2, {
                            __lang: __lang,
