...
function nextTranslate(nextConfig) {
    ...
    if (!fs.existsSync(process.cwd() + file))
        file = '/i18n.json';
    if (!fs.existsSync(process.cwd() + file)) {
        console.error('🚨 [next-translate] You should provide the next-translate config inside i18n.js / i18n.json root file.');
        return nextConfig;
    }
    ...
    if (app) {
        ...
        hasGetInitialPropsOnAppJs =
            !!code.match(/\WgetInitialProps\W/g) || utils_1.hasHOC(code);
    }
