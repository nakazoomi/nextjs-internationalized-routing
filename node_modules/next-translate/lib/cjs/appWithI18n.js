...
function appWithI18n(AppToTranslate, config) {
    ...
    function AppWithTranslations(props) {
        var _a, _b;
        var logger = config.logger, loadLocaleFrom = config.loadLocaleFrom, defaultLocale = config.defaultLocale;
        return (react_1.default.createElement(I18nProvider_1.default, { lang: ((_a = props.pageProps) === null || _a === void 0 ? void 0 : _a.__lang) || props.__lang || defaultLocale, namespaces: ((_b = props.pageProps) === null || _b === void 0 ? void 0 : _b.__namespaces) || props.__namespaces, logger: logger, loadLocaleFrom: loadLocaleFrom },
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    return [4, loadNamespaces_1.default(__assign(__assign(__assign({}, ctx), config), { loaderName: 'getInitialProps' }))];
