...
function formatElements(value, elements) {
    ...
    getElements(parts).forEach(function (_a, realIndex) {
        ...
        tree.push(react_1.cloneElement(element, { key: realIndex }, children
...
function Trans(_a) {
    var i18nKey = _a.i18nKey, values = _a.values, components = _a.components, fallback = _a.fallback;
    var t = useTranslation_1.default().t;
    var result = react_1.useMemo(function () {
        var text = t(i18nKey, values, { fallback: fallback });
